...
<PMML xmlns="http://www.dmg.org/PMML-4_3" version="4.3">
    ...
    <TreeModel modelName="golfing" functionName="classification" missingValueStrategy="aggregateNodes">
        <MiningSchema>
            <MiningField name="temperature"/>
            <MiningField name="humidity"/>
            <MiningField name="outlook"/>
...
<PMML xmlns="http://www.dmg.org/PMML-4_3" version="4.3">
	...
	<TreeModel modelName="golfing" functionName="classification" missingValueStrategy="lastPrediction">
	<MiningSchema>
		<MiningField name="temperature"/>
		<MiningField name="humidity"/>
		<MiningField name="outlook"/>
...
<PMML xmlns="http://www.dmg.org/PMML-4_3" version="4.3">
	...
	<TreeModel modelName="golfing" functionName="classification" missingValueStrategy="nullPrediction">
	<MiningSchema>
		<MiningField name="temperature"/>
		<MiningField name="humidity"/>
		<MiningField name="outlook"/>
...
func TestTreeModel(t *testing.T) {
	...
	err := xml.NewDecoder(bytes.NewReader(normal)).Decode(&doc)
...
func TestTreeMode_Confidence1(t *testing.T) {
	...
	err := xml.NewDecoder(bytes.NewReader(missingValueStrategies)).Decode(&doc)
	require.NoError(t, err)
	require.Len(t, doc.Models, 1)
...
func TestTreeMode_WeightedConfidence(t *testing.T) {
	var doc models.PMML
...
func TestTreeMode_DefaultChild(t *testing.T) {
	...
	err := xml.NewDecoder(bytes.NewReader(defaultChild)).Decode(&doc)
	require.NoError(t, err)
	require.Len(t, doc.Models, 1)
	...
	out, err := tm.Evaluate(evaluation.DataRow{
		"temperature": evaluation.NewValue(40.0),
		"humidity":    evaluation.NewValue(70.0),
	})
	require.NoError(t, err)
...
func TestTreeMode_LastPrediction(t *testing.T) {
	...
	err := xml.NewDecoder(bytes.NewReader(lastPrediction)).Decode(&doc)
	require.NoError(t, err)
	require.Len(t, doc.Models, 1)
...
func TestTreeMode_AggregateNodes(t *testing.T) {
	...
	err := xml.NewDecoder(bytes.NewReader(aggregateNodes)).Decode(&doc)
	require.NoError(t, err)
	require.Len(t, doc.Models, 1)
	...
	out, err := tm.Evaluate(evaluation.DataRow{
		"temperature": evaluation.NewValue(45.0),
		"humidity":    evaluation.NewValue(90.0),
	})
	require.NoError(t, err)
...
func TestTreeMode_NullPredictedValue(t *testing.T) {
	var doc models.PMML

	err := xml.NewDecoder(bytes.NewReader(nullPredictedValue)).Decode(&doc)
	require.NoError(t, err)
	require.Len(t, doc.Models, 1)
